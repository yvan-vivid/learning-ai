...
from typing import Set, Tuple, Optional, TypeVar, Generic, Dict, Iterable
from typing_extensions import Self

from micrograd.ident import HasIdentities, IdentManager
...
class Dag(Generic[D], HasIdentities):
    ...
    def node(
        self, data: D, *pred: DagNode[D], label: Optional[str] = None
    ) -> DagNode[D]:
